    ...
    ModalDrawerSheet(modifier = Modifier.width(width = 320.dp)) {
        ...
        Column(
            ...
            NavigationDrawerItem(
                ...
                icon = {
                    Icon(
                        imageVector = Icons.Filled.Home, // Icons.Outlined.Home
            ...
            NavigationDrawerItem(
                ...
                icon = {
                    Icon(
                        imageVector = Icons.Filled.Settings, // Icons.Outlined.Settings
                        contentDescription = null
                    )
                }
            )
            ...
            NavigationDrawerItem(
                ...
                icon = {
                    Icon(
                        imageVector = Icons.Filled.Info, // Icons.Outlined.Info
                        contentDescription = null
                    )
                }
            )
